...
@CucumberOptions(features= {"src/main/resources/scenarios"},
										...
										monochrome = true,
										  dryRun = false)
public class NxcWebCucumberDemo extends AbstractTestNGCucumberTests {
	...
	public void beforeall(ITestContext context, String platformname) throws IOException {
		 ...
		 context.getCurrentXmlTest().getAllParameters();
	      ...
	      CommonFunctions.getConfig().setProperty("LoginScreen.instance", new LoginScreenPageObject(driver));
		  CommonFunctions.getConfig().setProperty("HomeScreen.instance", new HomeScreenPageObject(driver));
	}
